...
app.use('/api/search', searchRoutes); // handles /api/search/youtube, /api/search/forge-posts
app.use('/api/search/google', googleSearchRoutes); // handles /api/search/google/web|images|news
